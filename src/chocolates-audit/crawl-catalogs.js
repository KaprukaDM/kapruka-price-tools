// Crawls each NEW competitor site's FULL chocolates/confectionery catalogue
// and caches it in Supabase (competitor_products). spar2u.lk (already
// crawled for Home & Lifestyle with its full unfiltered catalogue) is NOT
// re-crawled here — match-local.js reuses its existing cached data directly.
//
// Usage: node src/chocolates-audit/crawl-catalogs.js [--only=domain1,domain2]
