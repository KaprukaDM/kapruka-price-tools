// Crawls each competitor site's FULL sports/fitness catalogue and caches it
// in Supabase (competitor_products) for the local-match step to use.
//
// Usage: node src/sports-audit/crawl-catalogs.js [--only=domain1,domain2]
