// Matches Kapruka's Cosmetics catalog against each competitor site's CACHED
// full catalogue (competitor_products, populated by crawl-catalogs.js).
// Same exact-model-code matching logic as electronics-audit/match-local.js —
// see that file's comments for rationale (overlap coefficient, not Jaccard;
// requires a shared model code, no fuzzy name-only path).
//
// Usage: node src/cosmetics-audit/match-local.js [--limit=N] [--sites=domain1,domain2]
...
const KAPRUKA_SOURCE = { type: 'catalogue', buy: 'cosmetics', subcat: null };
