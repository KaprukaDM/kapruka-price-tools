// Crawls each competitor site's FULL cosmetics catalogue and caches it in
// Supabase (competitor_products) for the local-match step (match-local.js)
// to use instead of live-searching every Kapruka product.
//
// Usage: node src/cosmetics-audit/crawl-catalogs.js [--only=domain1,domain2]
